...
public class SecondTask {
        ...
        static Person fourthPerson = new Person("Helen", "Blooms", 548796);
    public static void main(String[] args)
    {
        ...
        System.out.println(fourthPerson.getFirstName() + ' ' + fourthPerson.getLastName() + ", passport " + fourthPerson.getPassportId());
    }
}
